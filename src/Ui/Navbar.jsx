...
function Navbar({ isMenuOpen, setIsMenuOpen }) {
  ...
  return (
    <nav className="fixed top-2 left-1/2 transform -translate-x-1/2 w-11/12 max-w-4xl z-40 bg-white/10 backdrop-blur-xl rounded-full border border-white/20 shadow-2xl">
      <div className="px-6">
