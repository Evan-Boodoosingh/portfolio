  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4">
        <h2 className="w-full text-4xl md:text-5xl lg:text-5xl font-semibold mb-6 bg-linear-to-r from-teal-400 via-blue-500 to-indigo-600 bg-clip-text text-transparent text-center leading-relaxed py-2">
          Featured Projects
        </h2>
